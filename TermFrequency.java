...
public class TermFrequency extends Configured implements Tool {
   ...
   private static final Logger LOG = Logger .getLogger( TermFrequency.class);//The class begins by initializing the logger.
   //The main method invokes ToolRunner, which creates and runs a new instance of TermFrequency, passing the command line arguments.
   ...
   public static class Reduce extends Reducer<Text ,  IntWritable ,  Text ,  DoubleWritable > {
      ...
      public void reduce( Text cword,  Iterable<IntWritable > counts,  Context context)
         ...
         double TF=(double)( 1+ Math.log10(sum));// Termfrequency calculation step
